  ...
  return (
    <div className="landingPage">
      ...
      <section id="how-it-works" className="landingSection landingHow">
        ...
        <div className="landingIntel">
          <div className="landingIntel__header">
            <h3>
          ...
          <div className="landingIntel__grid">
            <article className="intelCard intelCard--score">
              <h4>Match Score</h4>
              <div className="intelScore__value">95%</div>
              <div className="intelScore__bar">
                <span style={{ width: "95%" }} />
              </div>
              <p>Perfect match for this role based on skills and experience</p>
            </article>

            <article className="intelCard">
              <h4>Profile Score</h4>
              <div className="intelBars">
                <div className="intelBars__row">
                  <span>Skills</span>
                  <strong>85%</strong>
                </div>
                <div className="intelBars__track">
                  <span style={{ width: "85%" }} />
                </div>
              ...
              <p>Improve your score to get more visibility</p>
            </article>

            <article className="intelCard">
              <h4>Price Prediction</h4>
              <div className="intelMeta">Suggested Rate</div>
              <div className="intelPrice">$85/hr</div>

              <div className="intelList">
                <div className="intelList__item">
              ...
              <p>AI-calculated based on your profile and market data</p>
            </article>
          </div>
        </div>
      </section>
